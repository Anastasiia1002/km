...
`context` — українською: з якого блоку / кнопки користувач перейшов до форми (зберігається в `sessionStorage` до сабміту).  
...
| Значення | Де кнопка |
| --- | --- |
| `Хедер` | Десктоп-кнопка «Залишити заявку» в хедері |
| `Мобільне меню` | Кнопка в мобільному меню |
| `Банер головної` | Верхній банер головної сторінки |
| `Калькулятор економії` | Калькулятор економії пального |
| `Як ми працюємо` | Блок «Як ми працюємо» |
| `Тарифи · Стандарт` | Кнопка «Обрати пакет» у тарифі Стандарт |
| `Тарифи · Комуналка` | Кнопка «Обрати пакет» у тарифі Комуналка |
| `Тарифи · VIP` | Кнопка «Обрати пакет» у тарифі VIP |
| `Калькулятор тарифів` | Міні-калькулятор у блоці цін |
| `Контакти` | Картка контактів |
| `Банер сторінки регіону` | Верхній банер регіональної сторінки |
| `Банер сторінки рішення` | Верхній банер галузевої сторінки (включно з доставкою `/gps-dlya-dostavky/`) |
| `Блок заявки на сторінці регіону` | Блок «Спробувати безкоштовно» посеред тексту регіональної сторінки |
| `Блок заявки на сторінці рішення` | Блок «Спробувати безкоштовно» посеред тексту галузевої сторінки |
| `Блок заявки в статті` | Блок «Спробувати безкоштовно» посеред тексту статті |
| `Сайдбар` | Бічний блок «КМ Трейд поруч» |
| `Нижня кнопка` | Sticky-кнопка внизу на мобільних |
| `Форма тест-драйву` | Форму заповнили без попереднього кліку по CTA |

«Блок заявки …» — це не банер зверху, а окремий заклик до дії всередині тексту сторінки (кнопка «Спробувати безкоштовно»).
