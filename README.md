...
- **Online-кабінет:** модальна форма техпідтримки (компанія, ПІБ, телефон, повідомлення, файли) → `POST /client-nexus-portal/process.php`. PHP API для BAF: `get_list.php`, `update_status.php`.
