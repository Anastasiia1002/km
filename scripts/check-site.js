...
const requiredPublicFiles = [
  ...
  "assets/articles/iak-gps-monitorynh-dopomahaie-zapobihty-zlyvam-palnoho.jpg",
...
for (const page of seoPages) {
  ...
  const pageHtml = await readFile(path.join(distDir, relative), "utf8");
...
await assertFile(path.join(publicDir, "client-nexus-portal"), "csrf.php");
