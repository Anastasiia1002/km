...
export const regions = [
  ...
  },
  {
    ...
    description:
      "GPS-моніторинг транспорту у Хмельницькому та області: Wialon, контроль пального, підтримка 24/7, тест 14 днів.",
  ...
  },
  {
    ...
    description:
      "GPS-моніторинг транспорту в Києві та Київській області: Wialon, контроль автопарку, підтримка 24/7, тест 14 днів.",
...
export const industries = [
  ...
  },
  {
    ...
    features: ["Службові маршрути", "Звіти для бухгалтерії", "Особисті поїздки", "Підтримка 24/7"],
  },
  {
    slug: "gps-dlya-azs",
    icon: "⛽",
...
export const prices = [
  ...
  ["VIP", "250 грн", "за авто від 50 авто", ["Весь сервіс безкоштовний з першого дня", "Підтримка 24/7", "Пріоритетна підтримка", "Додаток iOS та Android", "Мобільний зв'язок включено з роумінгом", "Пост-гарантійний сервіс безкоштовно"]],
];
