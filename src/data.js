...
export const prices = [
  ...
  ["VIP", "250 грн", "за авто від 50 авто", ["Весь сервіс безкоштовний з першого дня", "Персональний менеджер", "Пріоритетна підтримка", "Мобільний зв'язок включено з роумінгом", "Пост-гарантійний сервіс включено"]],
];
